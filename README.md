...
<ul>
  <li>🎓 <b>B.Tech CSE</b> student at <b>PSIT Kanpur</b> — specializing in Artificial Intelligence</li>
  <li>💼 <b>Associate Technical Lead Intern</b> — shipping features end-to-end in production</li>
  <li>💻 <b>MERN Stack Developer</b> — React, Node.js, Express & MongoDB</li>
  <li>🤖 <b>AI / ML Enthusiast</b> — exploring LLMs, Computer Vision & intelligent systems</li>
  <li>🧠 <b>DSA Focused</b> — consistent problem-solving & competitive programming</li>
  <li>🚀 <b>Building real-world projects</b> with clean UI and scalable backend logic</li>
</ul>
...
<img src="https://skillicons.dev/icons?i=html,css,javascript,react,nodejs,express,mongodb,python,cpp,java,git,github,vscode,tailwind,postman,vite" alt="Tech Stack Icons" />
...
<table>
  ...
  <tr>
    ...
    <td align="center"><img src="https://img.shields.io/badge/MediaPipe-0095D2?style=for-the-badge&logo=google&logoColor=white" /></td>
    <td align="center"><img src="https://img.shields.io/badge/OpenRouter-101010?style=for-the-badge&logo=openai&logoColor=white" /></td>
  </tr>
  <tr>
    ...
    <td align="center"><img src="https://img.shields.io/badge/Git-F05033?style=for-the-badge&logo=git&logoColor=white" /></td>
  </tr>
</table>
...
### 🧠 DocuMind AI
> AI-powered GitHub documentation generator that turns repos into clean, structured READMEs.

**🛠️ Tech:** `React` `Node.js` `Express` `OpenRouter AI`

**✨ Highlights**
- 📝 Auto-generates documentation from source code
- 🤖 LLM-powered summarization via OpenRouter
- ⚡ Fast, lightweight full-stack workflow

</td>
<td width="50%" valign="top">

### 📦 AssetFlow ERP
> Enterprise-grade asset management platform for tracking inventory, operations & workflows.
...
> Real-time computer vision system that detects driver fatigue and triggers safety alerts.

**🛠️ Tech:** `Python` `OpenCV` `MediaPipe`

**✨ Highlights**
- 👁️ Eye Aspect Ratio analysis
...
> Employee performance management platform for tracking goals, reviews & KPIs.

**🛠️ Tech:** `MongoDB` `Express` `React` `Node.js`

**✨ Highlights**
- 👥 Multi-role dashboards (HR / Manager / Employee)
- 📈 KPI tracking & review cycles
- 📨 In-app notifications & feedback loops
...
<div align="center">
<img src="https://github-readme-streak-stats.herokuapp.com/?user=Shreya-1416&theme=tokyonight&hide_border=true" alt="GitHub Streak" />
</div>
...
<div align="center">
<img src="https://github-readme-activity-graph.vercel.app/graph?username=Shreya-1416&theme=tokyo-night&hide_border=true" alt="Activity Graph" />
</div>
...
<ul>
  <li>🎓 <b>IBM Machine Learning Certificate</b></li>
  <li>🗄️ <b>HackerRank SQL Certificate</b></li>
  <li>🎨 <b>CSS Certification</b></li>
  <li>💻 <b>LeetCode</b> — consistent DSA practice & problem solving</li>
  <li>🏅 <b>Hackathon</b> participant — collaborative, time-bound problem solving</li>
</ul>
...
> ⚠️ **Action needed:** Replace `YOUR_LINKEDIN_URL` (e.g. `https://www.linkedin.com/in/<your-handle>/`) and `YOUR_EMAIL` (e.g. `you@example.com`) with your real values before publishing.
